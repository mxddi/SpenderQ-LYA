...
# OUTPUT_DIR and RECON_NORM_RATIOS_DIR are set per-quasar at runtime.
...
CONTINUUM_RATIO_WAVE_LO = 3500.0
...
def _run_quasar(quasar_name, obs1_filename, obs2_filename, z_qso, CASE_DIR):
    ...
    in_range = (wave >= CONTINUUM_RATIO_WAVE_LO) & (wave <= CONTINUUM_RATIO_WAVE_HI)
    ...
    axes[1].set_xlabel("observed wavelength [Å]")
    axes[1].set_xlim(CONTINUUM_RATIO_WAVE_LO, CONTINUUM_RATIO_WAVE_HI)
